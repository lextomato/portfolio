...
<template>
    <div>
        ...
        <div class="text-center w-100">
            ...
            <div class="col-6">
                <button id="btn-front" @click="store.frontend()" class="btn btn-outline-success w-100 mx-1 border-2 rounded-4" data-bs-dismiss="offcanvas" aria-label="Close">
            ...
            <div class="col-6">
                <button id="btn-back" @click="store.backend()" :class="store.isFrontend? 'btn-outline-dark':'btn-outline-secondary'" class="btn w-100 mx-1 fw-semibold border-2 rounded-4" data-bs-dismiss="offcanvas" aria-label="Close">
        ...
        <ul :class="store.isChanging? 'glitch-text':''" class="nav flex-column mt-3 fs-min">
            <li for="to-1" class="nav-item" data-bs-dismiss="offcanvas" aria-label="Close">
                <RouterLink id="to-1" class="nav-link" to="/about-me">{{ $t('to-about-me') }}</RouterLink>
            </li>
            <li for="to-2" class="nav-item" data-bs-dismiss="offcanvas" aria-label="Close">
                <RouterLink id="to-2" class="nav-link" to="/experience">{{ $t('to-experience') }}</RouterLink>
            </li>
            <li for="to-3" class="nav-item" data-bs-dismiss="offcanvas" aria-label="Close">
                <RouterLink id="to-3" class="nav-link" to="/tecnologies">{{ $t('to-tecnologies') }}</RouterLink>
            </li>
            <li class="nav-item">
